...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-k1cnxfw1"
local actions={{start=0,release=6,finish=66,keys={"a"}},{start=66,release=72,finish=222,keys={"a"}},{start=222,release=228,finish=288,keys={"a"}},{start=288,release=294,finish=354,keys={"b"}},{start=354,release=360,finish=450,keys={"start"}}}
local frame=0
