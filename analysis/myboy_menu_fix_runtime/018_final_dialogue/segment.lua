...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-f6fad22_"
local actions={{start=0,release=6,finish=51,keys={"b"}},{start=51,release=57,finish=207,keys={"l"}},{start=207,release=213,finish=333,keys={"a"}},{start=333,release=339,finish=429,keys={"a"}}}
local frame=0
