...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-qa9x6vow"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=192,keys={"a"}},{start=192,release=198,finish=258,keys={"b"}},{start=258,release=264,finish=324,keys={"b"}},{start=324,release=330,finish=375,keys={"b"}},{start=375,release=381,finish=471,keys={"start"}},{start=471,release=477,finish=522,keys={"b"}},{start=522,release=528,finish=618,keys={"start"}}}
local frame=0
