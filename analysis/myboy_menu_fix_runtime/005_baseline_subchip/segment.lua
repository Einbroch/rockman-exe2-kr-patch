...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-qbkz7q3s"
local actions={{start=0,release=6,finish=26,keys={"down"}},{start=26,release=32,finish=122,keys={"a"}}}
local frame=0
...
local function capture(name)
 ...
 if true then
  ...
  local regs={}
  for i=0,15 do regs[#regs+1]=string.format('"r%d":%d',i,cpu['r'..i]) end
