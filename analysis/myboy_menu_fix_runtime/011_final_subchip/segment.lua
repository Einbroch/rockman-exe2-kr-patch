...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-utjdmnjz"
local actions={{start=0,release=6,finish=26,keys={"down"}},{start=26,release=32,finish=122,keys={"a"}},{start=122,release=128,finish=188,keys={"b"}}}
local frame=0
