...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-wld34x0v"
local actions={{start=0,release=1,finish=300,keys={}},{start=300,release=306,finish=426,keys={"start"}},{start=426,release=432,finish=612,keys={"a"}},{start=612,release=618,finish=708,keys={"start"}},{start=708,release=714,finish=894,keys={"a"}},{start=894,release=900,finish=1020,keys={"start"}}}
local frame=0
