...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-skqf_ybw"
local actions={{start=0,release=6,finish=126,keys={"right"}},{start=126,release=132,finish=252,keys={"left"}},{start=252,release=258,finish=318,keys={"down"}},{start=318,release=324,finish=384,keys={"down"}},{start=384,release=390,finish=450,keys={"down"}},{start=450,release=456,finish=516,keys={"b"}}}
local frame=0
