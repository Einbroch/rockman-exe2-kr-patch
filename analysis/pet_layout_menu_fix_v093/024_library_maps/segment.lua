...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-jt74hhic"
local actions={{start=0,release=6,finish=26,keys={"down"}},{start=26,release=32,finish=52,keys={"down"}},{start=52,release=58,finish=178,keys={"a"}}}
local frame=0
...
local function capture(name)
 ...
 if true then
  ...
  -- Submenu titles are composed on the other BG map pages; retain them for
  -- read-only tilemap attribution when tracing a candidate.
