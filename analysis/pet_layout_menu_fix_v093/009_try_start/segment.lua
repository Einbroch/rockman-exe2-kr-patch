...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-98p30vhg"
local actions={{start=0,release=6,finish=126,keys={"start"}},{start=126,release=132,finish=252,keys={"start"}},{start=252,release=258,finish=378,keys={"b"}},{start=378,release=384,finish=504,keys={"a"}}}
local frame=0
