...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-hg00epn8"
local actions={{start=0,release=6,finish=26,keys={"down"}},{start=26,release=32,finish=52,keys={"down"}},{start=52,release=58,finish=78,keys={"down"}},{start=78,release=84,finish=104,keys={"down"}},{start=104,release=110,finish=130,keys={"down"}},{start=130,release=136,finish=156,keys={"down"}},{start=156,release=162,finish=282,keys={"a"}}}
local frame=0
