...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-1ro2au7d"
local actions={{start=0,release=6,finish=26,keys={"down"}},{start=26,release=32,finish=52,keys={"down"}},{start=52,release=58,finish=78,keys={"down"}},{start=78,release=84,finish=204,keys={"a"}}}
local frame=0
