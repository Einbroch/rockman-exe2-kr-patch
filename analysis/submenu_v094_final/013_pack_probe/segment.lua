...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-m2ytwdyb"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=192,keys={"a"}},{start=192,release=198,finish=288,keys={"right"}}}
local frame=0
