...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-2ni72dbr"
local actions={{start=0,release=6,finish=26,keys={"down"}},{start=26,release=32,finish=52,keys={"down"}},{start=52,release=58,finish=208,keys={"a"}}}
local frame=0
