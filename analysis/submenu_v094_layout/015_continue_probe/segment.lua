...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-4venq7al"
local actions={{start=0,release=6,finish=186,keys={"a"}},{start=186,release=192,finish=312,keys={"start"}},{start=312,release=318,finish=498,keys={"a"}},{start=498,release=504,finish=624,keys={"start"}}}
local frame=0
