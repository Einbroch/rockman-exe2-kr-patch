...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-p1pcudjm"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=192,keys={"a"}},{start=192,release=198,finish=258,keys={"down"}},{start=258,release=264,finish=324,keys={"b"}},{start=324,release=330,finish=390,keys={"b"}}}
local frame=0
