...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-3pgwslzk"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=192,keys={"a"}},{start=192,release=198,finish=288,keys={"a"}},{start=288,release=294,finish=364,keys={"b"}},{start=364,release=370,finish=490,keys={"start"}}}
local frame=0
