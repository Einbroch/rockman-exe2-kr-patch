...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-blupoj1w"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=192,keys={"a"}},{start=192,release=198,finish=268,keys={"b"}},{start=268,release=274,finish=364,keys={"b"}},{start=364,release=368,finish=418,keys={"down"}},{start=418,release=424,finish=514,keys={"a"}},{start=514,release=520,finish=610,keys={"b"}},{start=610,release=616,finish=706,keys={"b"}}}
local frame=0
