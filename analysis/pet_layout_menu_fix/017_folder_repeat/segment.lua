...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-0sk81804"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=192,keys={"a"}},{start=192,release=198,finish=268,keys={"b"}},{start=268,release=274,finish=364,keys={"b"}},{start=364,release=370,finish=460,keys={"b"}},{start=460,release=466,finish=586,keys={"start"}},{start=586,release=592,finish=682,keys={"b"}},{start=682,release=688,finish=808,keys={"start"}}}
local frame=0
