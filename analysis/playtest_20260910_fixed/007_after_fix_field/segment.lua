...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-0vaczt9i"
local actions={{start=0,release=6,finish=186,keys={"a"}},{start=186,release=196,finish=216,keys={"down"}},{start=216,release=222,finish=262,keys={"start"}},{start=262,release=268,finish=288,keys={"up"}},{start=288,release=294,finish=314,keys={"up"}},{start=314,release=320,finish=410,keys={"a"}}}
local frame=0
