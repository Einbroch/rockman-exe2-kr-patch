...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-m1443s0o"
local actions={{start=0,release=45,finish=55,keys={"left"}},{start=55,release=80,finish=90,keys={"up"}},{start=90,release=96,finish=276,keys={"a"}}}
local frame=0
