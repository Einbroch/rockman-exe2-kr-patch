...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-vrhrqv4g"
local actions={{start=0,release=6,finish=186,keys={"b"}},{start=186,release=192,finish=372,keys={"a"}}}
local frame=0
