...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-2nuvoy4p"
local actions={{start=0,release=18,finish=38,keys={"left"}},{start=38,release=44,finish=224,keys={"a"}}}
local frame=0
