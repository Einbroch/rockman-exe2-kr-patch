...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-kkvttx6c"
local actions={{start=0,release=75,finish=95,keys={"left"}},{start=95,release=170,finish=190,keys={"up"}},{start=190,release=196,finish=376,keys={"a"}}}
local frame=0
