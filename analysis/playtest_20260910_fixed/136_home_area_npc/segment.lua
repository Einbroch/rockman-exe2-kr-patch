...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-ynwt0i5v"
local actions={{start=0,release=70,finish=90,keys={"right"}},{start=90,release=135,finish=155,keys={"down"}},{start=155,release=161,finish=341,keys={"a"}}}
local frame=0
