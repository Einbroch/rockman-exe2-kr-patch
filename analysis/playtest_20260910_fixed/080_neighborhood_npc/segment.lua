...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-n3matnbk"
local actions={{start=0,release=70,finish=80,keys={"right"}},{start=80,release=115,finish=125,keys={"up"}},{start=125,release=131,finish=311,keys={"a"}}}
local frame=0
