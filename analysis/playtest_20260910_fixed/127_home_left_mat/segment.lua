...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-um1mofmm"
local actions={{start=0,release=40,finish=60,keys={"down","left"}},{start=60,release=66,finish=246,keys={"a"}}}
local frame=0
