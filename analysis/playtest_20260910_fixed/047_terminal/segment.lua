...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-k3nfx17l"
local actions={{start=0,release=1,finish=31,keys={"a"}},{start=31,release=32,finish=212,keys={"b"}},{start=212,release=213,finish=393,keys={"a"}}}
local frame=0
