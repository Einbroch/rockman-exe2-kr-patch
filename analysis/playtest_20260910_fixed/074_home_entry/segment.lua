...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-9x1wz_y4"
local actions={{start=0,release=20,finish=30,keys={"left"}},{start=30,release=50,finish=60,keys={"up"}},{start=60,release=66,finish=246,keys={"a"}}}
local frame=0
