...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-f8wh2jlv"
local actions={{start=0,release=35,finish=55,keys={"up"}},{start=55,release=61,finish=241,keys={"a"}}}
local frame=0
