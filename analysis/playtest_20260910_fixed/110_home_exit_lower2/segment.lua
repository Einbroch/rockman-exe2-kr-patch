...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-o0alpe13"
local actions={{start=0,release=80,finish=100,keys={"down"}},{start=100,release=130,finish=150,keys={"right"}}}
local frame=0
