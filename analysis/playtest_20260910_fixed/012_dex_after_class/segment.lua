...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-ykf9iue3"
local actions={{start=0,release=82,finish=92,keys={"left"}},{start=92,release=100,finish=110,keys={"left"}},{start=110,release=116,finish=296,keys={"a"}}}
local frame=0
