...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-n1puuzcg"
local actions={{start=0,release=45,finish=60,keys={"left"}},{start=60,release=105,finish=120,keys={"down"}},{start=120,release=126,finish=306,keys={"a"}}}
local frame=0
