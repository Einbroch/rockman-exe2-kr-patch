...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-jwokt6k0"
local actions={{start=0,release=30,finish=50,keys={"down","left"}},{start=50,release=56,finish=236,keys={"a"}}}
local frame=0
