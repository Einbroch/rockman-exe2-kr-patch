...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-zg5vrj8v"
local actions={{start=0,release=1,finish=600,keys={}},{start=600,release=606,finish=726,keys={"start"}},{start=726,release=732,finish=912,keys={"a"}},{start=912,release=918,finish=1098,keys={"l"}}}
local frame=0
