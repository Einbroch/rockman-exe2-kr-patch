...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-eagk6xfz"
local actions={{start=0,release=80,finish=100,keys={"up"}},{start=100,release=106,finish=286,keys={"a"}}}
local frame=0
