...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-7mpqvqff"
local actions={{start=0,release=50,finish=70,keys={"left"}},{start=70,release=140,finish=160,keys={"up"}}}
local frame=0
