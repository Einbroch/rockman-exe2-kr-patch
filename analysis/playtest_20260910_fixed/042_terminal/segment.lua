...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-eag8iuta"
local actions={{start=0,release=6,finish=186,keys={"a"}},{start=186,release=192,finish=372,keys={"a"}},{start=372,release=378,finish=558,keys={"a"}}}
local frame=0
