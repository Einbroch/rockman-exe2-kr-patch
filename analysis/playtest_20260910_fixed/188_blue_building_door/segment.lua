...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-vs627gfj"
local actions={{start=0,release=25,finish=45,keys={"down"}},{start=45,release=51,finish=231,keys={"a"}}}
local frame=0
