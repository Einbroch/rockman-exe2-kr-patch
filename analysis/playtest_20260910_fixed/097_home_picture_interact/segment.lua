...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-saopc79a"
local actions={{start=0,release=20,finish=40,keys={"up"}},{start=40,release=46,finish=166,keys={"a"}}}
local frame=0
