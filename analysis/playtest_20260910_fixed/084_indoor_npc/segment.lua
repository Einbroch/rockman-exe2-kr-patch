...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-c551p5om"
local actions={{start=0,release=90,finish=110,keys={"up"}},{start=110,release=160,finish=180,keys={"left"}},{start=180,release=186,finish=366,keys={"a"}}}
local frame=0
