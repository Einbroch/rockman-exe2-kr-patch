...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-vmja0ck7"
local actions={{start=0,release=20,finish=30,keys={"up"}},{start=30,release=36,finish=216,keys={"a"}}}
local frame=0
