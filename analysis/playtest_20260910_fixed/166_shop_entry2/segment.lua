...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-s7szgb8s"
local actions={{start=0,release=6,finish=186,keys={"a"}},{start=186,release=231,finish=251,keys={"up","left"}},{start=251,release=257,finish=437,keys={"a"}}}
local frame=0
