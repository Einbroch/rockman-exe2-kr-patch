...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-gbckee4d"
local actions={{start=0,release=6,finish=36,keys={"b"}},{start=36,release=66,finish=86,keys={"right"}},{start=86,release=146,finish=166,keys={"up"}}}
local frame=0
