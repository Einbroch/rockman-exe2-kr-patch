...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-qxqohyaj"
local actions={{start=0,release=50,finish=70,keys={"right"}},{start=70,release=95,finish=115,keys={"up"}},{start=115,release=121,finish=301,keys={"a"}}}
local frame=0
