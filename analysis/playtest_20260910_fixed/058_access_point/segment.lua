...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-gmxvfc_m"
local actions={{start=0,release=40,finish=50,keys={"down"}},{start=50,release=70,finish=80,keys={"right"}},{start=80,release=86,finish=266,keys={"a"}}}
local frame=0
