...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-h0f36d_n"
local actions={{start=0,release=6,finish=186,keys={"a"}},{start=186,release=192,finish=372,keys={"a"}},{start=372,release=378,finish=558,keys={"a"}},{start=558,release=564,finish=744,keys={"a"}},{start=744,release=750,finish=930,keys={"a"}}}
local frame=0
