...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-94_6ocbo"
local actions={{start=0,release=35,finish=55,keys={"up"}},{start=55,release=90,finish=110,keys={"left"}},{start=110,release=116,finish=296,keys={"a"}}}
local frame=0
