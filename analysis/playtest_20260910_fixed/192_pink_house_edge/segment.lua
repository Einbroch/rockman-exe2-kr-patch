...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-m0yv09ls"
local actions={{start=0,release=180,finish=200,keys={"up"}},{start=200,release=320,finish=340,keys={"right"}}}
local frame=0
