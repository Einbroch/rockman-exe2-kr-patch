...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-sibw6uly"
local actions={{start=0,release=45,finish=65,keys={"down"}},{start=65,release=110,finish=130,keys={"right"}},{start=130,release=136,finish=316,keys={"a"}}}
local frame=0
