...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-nqiqvckr"
local actions={{start=0,release=180,finish=200,keys={"up","left"}},{start=200,release=206,finish=386,keys={"a"}}}
local frame=0
