...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-yksg8q2z"
local actions={{start=0,release=55,finish=75,keys={"right"}},{start=75,release=130,finish=150,keys={"down"}},{start=150,release=156,finish=336,keys={"a"}}}
local frame=0
