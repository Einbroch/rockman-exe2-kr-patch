...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-uz_ubjf2"
local actions={{start=0,release=35,finish=45,keys={"up"}},{start=45,release=70,finish=80,keys={"left"}},{start=80,release=86,finish=266,keys={"a"}}}
local frame=0
