...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-zknvxm23"
local actions={{start=0,release=20,finish=40,keys={"down"}},{start=40,release=46,finish=226,keys={"a"}}}
local frame=0
