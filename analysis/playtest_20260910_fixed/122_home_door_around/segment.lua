...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-s2x8fget"
local actions={{start=0,release=70,finish=90,keys={"down","right"}},{start=90,release=180,finish=200,keys={"up","right"}}}
local frame=0
