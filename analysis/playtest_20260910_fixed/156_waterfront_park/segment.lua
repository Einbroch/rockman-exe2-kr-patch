...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-d0u0zm_t"
local actions={{start=0,release=100,finish=120,keys={"up"}},{start=120,release=190,finish=210,keys={"left"}},{start=210,release=216,finish=396,keys={"a"}}}
local frame=0
