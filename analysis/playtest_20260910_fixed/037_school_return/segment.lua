...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-mkyprtnc"
local actions={{start=0,release=120,finish=140,keys={"left"}},{start=140,release=220,finish=240,keys={"down"}}}
local frame=0
