...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-01tcp7ja"
local actions={{start=0,release=35,finish=45,keys={"up"}},{start=45,release=85,finish=95,keys={"right"}},{start=95,release=101,finish=281,keys={"a"}}}
local frame=0
