...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-1r1bp9bs"
local actions={{start=0,release=60,finish=80,keys={"down"}},{start=80,release=140,finish=160,keys={"right"}},{start=160,release=166,finish=346,keys={"a"}}}
local frame=0
