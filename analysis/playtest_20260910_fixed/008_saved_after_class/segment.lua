...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-a1vgqowq"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=222,keys={"a"}},{start=222,release=228,finish=258,keys={"b"}},{start=258,release=264,finish=294,keys={"b"}}}
local frame=0
