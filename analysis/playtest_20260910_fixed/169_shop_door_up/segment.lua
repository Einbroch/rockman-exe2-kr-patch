...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-naio0xl6"
local actions={{start=0,release=45,finish=65,keys={"up"}},{start=65,release=71,finish=251,keys={"a"}}}
local frame=0
