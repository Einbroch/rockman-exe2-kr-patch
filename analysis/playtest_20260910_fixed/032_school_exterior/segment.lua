...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-zmb4iqiw"
local actions={{start=0,release=100,finish=120,keys={"down"}},{start=120,release=220,finish=240,keys={"right"}}}
local frame=0
