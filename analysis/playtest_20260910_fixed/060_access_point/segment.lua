...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-xk26h9of"
local actions={{start=0,release=30,finish=40,keys={"up"}},{start=40,release=46,finish=226,keys={"a"}}}
local frame=0
