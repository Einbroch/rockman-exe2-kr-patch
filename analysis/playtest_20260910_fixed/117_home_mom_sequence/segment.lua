...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-jdqpz4sl"
local actions={{start=0,release=6,finish=66,keys={"a"}},{start=66,release=72,finish=252,keys={"a"}}}
local frame=0
