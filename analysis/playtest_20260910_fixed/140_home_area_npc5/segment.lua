...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-ab0qg65z"
local actions={{start=0,release=30,finish=50,keys={"down","right"}},{start=50,release=56,finish=236,keys={"a"}}}
local frame=0
