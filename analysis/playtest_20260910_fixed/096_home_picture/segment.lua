...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-hm_nsb5l"
local actions={{start=0,release=60,finish=80,keys={"right"}},{start=80,release=86,finish=206,keys={"a"}}}
local frame=0
