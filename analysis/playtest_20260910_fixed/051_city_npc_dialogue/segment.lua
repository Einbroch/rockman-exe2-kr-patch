...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-2ih97y4q"
local actions={{start=0,release=20,finish=30,keys={"down"}},{start=30,release=36,finish=216,keys={"a"}},{start=216,release=222,finish=402,keys={"a"}}}
local frame=0
