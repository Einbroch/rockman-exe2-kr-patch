...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-p266asx2"
local actions={{start=0,release=50,finish=70,keys={"up"}},{start=70,release=120,finish=140,keys={"right"}}}
local frame=0
