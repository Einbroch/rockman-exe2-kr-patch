...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-svzrdkz5"
local actions={{start=0,release=90,finish=110,keys={"down","right"}},{start=110,release=116,finish=296,keys={"a"}}}
local frame=0
