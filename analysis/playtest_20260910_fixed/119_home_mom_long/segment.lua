...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-4mk_1dlr"
local actions={{start=0,release=10,finish=190,keys={"a"}},{start=190,release=200,finish=380,keys={"a"}},{start=380,release=390,finish=570,keys={"a"}}}
local frame=0
