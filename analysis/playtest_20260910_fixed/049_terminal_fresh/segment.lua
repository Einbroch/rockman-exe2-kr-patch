...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-8gv2ienn"
local actions={{start=0,release=6,finish=186,keys={"a"}},{start=186,release=192,finish=372,keys={"a"}}}
local frame=0
