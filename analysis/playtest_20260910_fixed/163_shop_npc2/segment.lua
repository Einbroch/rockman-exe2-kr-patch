...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-r_yzfp_7"
local actions={{start=0,release=90,finish=110,keys={"right"}},{start=110,release=150,finish=170,keys={"down"}},{start=170,release=176,finish=356,keys={"a"}}}
local frame=0
