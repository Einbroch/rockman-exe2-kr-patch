...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-q0c8jwx3"
local actions={{start=0,release=70,finish=90,keys={"down"}},{start=90,release=140,finish=160,keys={"left"}},{start=160,release=166,finish=346,keys={"a"}}}
local frame=0
