...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-yecibeyz"
local actions={{start=0,release=100,finish=120,keys={"up","left"}},{start=120,release=126,finish=306,keys={"a"}}}
local frame=0
