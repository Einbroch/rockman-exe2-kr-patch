...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-biz1rohs"
local actions={{start=0,release=6,finish=106,keys={"select"}},{start=106,release=112,finish=212,keys={"up"}},{start=212,release=218,finish=318,keys={"down"}},{start=318,release=324,finish=424,keys={"left"}},{start=424,release=430,finish=610,keys={"right"}}}
local frame=0
