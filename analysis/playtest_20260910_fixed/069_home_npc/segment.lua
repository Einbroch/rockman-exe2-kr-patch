...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-e1ha_g24"
local actions={{start=0,release=35,finish=45,keys={"up"}},{start=45,release=51,finish=231,keys={"a"}}}
local frame=0
