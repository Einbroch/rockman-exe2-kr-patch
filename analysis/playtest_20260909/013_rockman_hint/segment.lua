...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-9x3md28g"
local actions={{start=0,release=6,finish=186,keys={"a"}},{start=186,release=192,finish=252,keys={"a"}},{start=252,release=258,finish=283,keys={"up"}},{start=283,release=289,finish=439,keys={"a"}}}
local frame=0
