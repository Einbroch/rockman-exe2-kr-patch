...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-wn50iqpz"
local actions={{start=0,release=10,finish=20,keys={"left"}},{start=20,release=26,finish=36,keys={"up"}},{start=36,release=42,finish=222,keys={"a"}}}
local frame=0
