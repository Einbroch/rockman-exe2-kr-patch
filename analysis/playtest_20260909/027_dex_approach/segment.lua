...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-y0qqgnm8"
local actions={{start=0,release=66,finish=76,keys={"left"}},{start=76,release=82,finish=92,keys={"up"}},{start=92,release=98,finish=278,keys={"a"}}}
local frame=0
