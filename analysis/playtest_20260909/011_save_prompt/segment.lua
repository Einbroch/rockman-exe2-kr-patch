...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-5ssx79ih"
local actions={{start=0,release=6,finish=36,keys={"start"}},{start=36,release=42,finish=67,keys={"up"}},{start=67,release=73,finish=98,keys={"up"}},{start=98,release=104,finish=194,keys={"a"}}}
local frame=0
