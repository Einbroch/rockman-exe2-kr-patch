...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-zloampij"
local actions={{start=0,release=2,finish=152,keys={"a"}},{start=152,release=154,finish=364,keys={"a"}},{start=364,release=366,finish=516,keys={"a"}},{start=516,release=518,finish=728,keys={"a"}},{start=728,release=730,finish=970,keys={"a"}}}
local frame=0
