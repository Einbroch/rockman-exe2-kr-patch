...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-9pcgofb_"
local actions={{start=0,release=6,finish=26,keys={"right"}},{start=26,release=32,finish=152,keys={"a"}}}
local frame=0
