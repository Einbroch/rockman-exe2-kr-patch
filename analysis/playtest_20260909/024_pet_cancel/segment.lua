...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-afelblp6"
local actions={{start=0,release=6,finish=156,keys={"b"}},{start=156,release=162,finish=192,keys={"a"}},{start=192,release=237,finish=247,keys={"down"}}}
local frame=0
