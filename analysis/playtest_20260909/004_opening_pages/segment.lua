...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-5gsfjchl"
local actions={{start=0,release=2,finish=152,keys={"a"}},{start=152,release=154,finish=304,keys={"a"}},{start=304,release=306,finish=456,keys={"a"}},{start=456,release=458,finish=608,keys={"a"}},{start=608,release=610,finish=760,keys={"a"}}}
local frame=0
