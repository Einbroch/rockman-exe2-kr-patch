...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-m4l79mzx"
local actions={{start=0,release=6,finish=36,keys={"a"}},{start=36,release=81,finish=101,keys={"left"}}}
local frame=0
