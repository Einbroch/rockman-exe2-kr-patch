...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-p4jkrivp"
local actions={{start=0,release=6,finish=156,keys={"a"}},{start=156,release=162,finish=207,keys={"a"}},{start=207,release=213,finish=258,keys={"b"}},{start=258,release=264,finish=309,keys={"b"}},{start=309,release=315,finish=495,keys={"l"}}}
local frame=0
