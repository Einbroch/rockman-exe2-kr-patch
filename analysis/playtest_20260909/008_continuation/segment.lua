...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-sj4a03ll"
local actions={{start=0,release=2,finish=182,keys={"a"}},{start=182,release=184,finish=364,keys={"a"}},{start=364,release=366,finish=546,keys={"a"}}}
local frame=0
