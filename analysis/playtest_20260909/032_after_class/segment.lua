...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-z4mkxjku"
local actions={{start=0,release=6,finish=246,keys={"a"}},{start=246,release=252,finish=432,keys={"a"}},{start=432,release=438,finish=618,keys={"a"}},{start=618,release=624,finish=804,keys={"a"}}}
local frame=0
