...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-yjv5l4ox"
local actions={{start=0,release=2,finish=242,keys={"a"}},{start=242,release=244,finish=424,keys={"a"}},{start=424,release=426,finish=606,keys={"a"}},{start=606,release=608,finish=788,keys={"a"}},{start=788,release=790,finish=970,keys={"a"}},{start=970,release=972,finish=1152,keys={"a"}},{start=1152,release=1154,finish=1334,keys={"a"}},{start=1334,release=1336,finish=1516,keys={"a"}}}
local frame=0
