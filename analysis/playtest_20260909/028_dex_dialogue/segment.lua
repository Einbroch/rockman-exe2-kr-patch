...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-defn2wg_"
local actions={{start=0,release=8,finish=18,keys={"left"}},{start=18,release=24,finish=204,keys={"a"}},{start=204,release=210,finish=390,keys={"a"}},{start=390,release=396,finish=576,keys={"a"}}}
local frame=0
