...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-1y99jln3"
local actions={{start=0,release=36,finish=46,keys={"left"}},{start=46,release=52,finish=62,keys={"up"}},{start=62,release=68,finish=248,keys={"a"}}}
local frame=0
