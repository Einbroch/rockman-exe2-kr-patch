...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-ejrfjyjt"
local actions={{start=0,release=2,finish=22,keys={"up"}},{start=22,release=24,finish=44,keys={"up"}},{start=44,release=46,finish=136,keys={"a"}}}
local frame=0
