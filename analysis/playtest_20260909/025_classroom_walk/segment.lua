...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-5ltweq3s"
local actions={{start=0,release=40,finish=50,keys={"left"}},{start=50,release=90,finish=100,keys={"down"}}}
local frame=0
