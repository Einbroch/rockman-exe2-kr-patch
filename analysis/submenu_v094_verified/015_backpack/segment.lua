...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-vvec9ugl"
local actions={{start=0,release=6,finish=96,keys={"a"}},{start=96,release=102,finish=192,keys={"a"}},{start=192,release=198,finish=318,keys={"right"}},{start=318,release=324,finish=444,keys={"left"}}}
local frame=0
