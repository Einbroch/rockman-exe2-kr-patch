...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-ws_yymxy"
local actions={{start=0,release=6,finish=156,keys={"a"}},{start=156,release=162,finish=312,keys={"a"}},{start=312,release=318,finish=408,keys={"b"}},{start=408,release=414,finish=504,keys={"start"}}}
local frame=0
