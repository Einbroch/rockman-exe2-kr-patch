...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-play-5j3vuy8p"
local actions={{start=0,release=6,finish=26,keys={"down"}},{start=26,release=32,finish=182,keys={"a"}}}
local frame=0
