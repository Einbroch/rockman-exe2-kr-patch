...
local root = "C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-pet-choice-hxiiundf"
local frame = 0
...
emu.addEventCallback(function()
 ...
 for _,n in ipairs({2050,2420,2700,3070,3350,3720}) do keyA=keyA or pulse(n) end
