...
local root="C:/Users/Public/Documents/ESTsoft/CreatorTemp/exe2-wrap-rmn4a191"
local frame=0
...
emu.addEventCallback(function()
 ...
 if frame==1800 then
  ...
  w(0x8730,1);w(0x8731,2);w(0x8738,2)
  u32(0x8754,0x02038800+756);u32(0x8758,0x02038800);u32(0x875C,0x02038800+756)
 end
